    ...
    return (
        <div className="container">
            ...
            <div className="card-alive" style={{ marginTop: '15px', textAlign: 'center' }}>
                <h1 className="name-alive" style={{ fontSize: '1.5rem' }}>TATU YUSSUF</h1>
                ...
                <div style={{
                    ...
                    <p><strong>MAELEZO:</strong> Tatu ni binti wa Yussuf Bin Khamis na Bibi Saade. Hapa ndipo kizazi chake kitakapoandikwa.</p>
                </div>
            </div>

            {/* SEHEMU YA WATOTO WA TATU (INFINITY) */}
